...
export const MonitorIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.25 0m-5.25 0a3.75 3.75 0 00-5.25 0m3.75 7.5a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-3.741 0a3 3 0 00-4.682 2.72c.522.262 1.053.475 1.597.639M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);

export const SettingsIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.226a11.25 11.25 0 012.27 0c.55.219 1.02.684 1.11 1.226.09.542-.12.986-.445 1.365a11.25 11.25 0 00-2.27 0c-.325-.38-.535-.823-.445-1.365zM12 21a9 9 0 100-18 9 9 0 000 18zM12 7.5a2.25 2.25 0 00-2.25 2.25v.008c0 .284.114.55.318.746l1.25 1.25a.75.75 0 001.06 0l1.25-1.25a.75.75 0 00.318-.746V9.75A2.25 2.25 0 0012 7.5z" />
  </svg>
);
...
export const BatteryIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 10.5h.375c.621 0 1.125.504 1.125 1.125v2.25c0 .621-.504 1.125-1.125 1.125H21M4.5 10.5a2.25 2.25 0 00-2.25 2.25v2.25a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 15v-2.25a2.25 2.25 0 00-2.25-2.25h-15z" />
  </svg>
);
...
export const MicrophoneIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75v-1.5a7.5 7.5 0 0115 0v1.5" />
    </svg>
);
